...
| Storage unavailable or recovery commit fails during startup | No readiness/traffic, no empty replacement database or in-memory success. Restore access and repeat coordinated startup safely; committed data remains. |
