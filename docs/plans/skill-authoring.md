...
| Async/query and scaling scenarios | Required complete DB offload and bounded/batched query evidence; identified exclusive startup recovery as incompatible with simply adding four workers on one volume. |
